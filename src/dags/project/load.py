...
def delivery_system_dag(p_date_from: str, p_date_to: str):
    ...
    def couriers():
        ...
        request_couriers = "https://d5d04q7d963eapoepsqr.apigw.yandexcloud.net/couriers?sort_field=_id&sort_direction=asc&limit={limit}&offset={offset}&from={date_from}&to={date_to}"
        #get_data(insert=insert_couriers, request=request_couriers, date_from=p_date_from, date_to=p_date_to)
    ...
    ##deliveries_load
    couriers_load
    #[couriers, temp] >> load_dm_couriers >> load_dm_deliveries >> load_courier_ledger

# per day
v_date_from = '2023-05-03%2000:00:00'
v_date_to='2023-05-04%2000:00:00'

delivery_system_dag = delivery_system_dag(p_date_to=v_date_to, p_date_from=v_date_from)
delivery_system_dag
print('Done')